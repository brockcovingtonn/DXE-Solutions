      ...
      <div style="padding: 28px 24px; border: 1px solid #DCE5EC; border-top: none; background: #FFFFFF;">
        ...
        <p>
          ${isEsign
            ...
            : `It's been a pleasure getting to know your project${quote.project_address ? ` at <strong>${escapeHtml(quote.project_address)}</strong>` : ''}, and we're genuinely excited about where this can go together. We've put together a proposal (${escapeHtml(quote.quote_number)}) with you in mind — take a look whenever you're ready.`}
        </p>
