      ...
      <div style="padding: 28px 24px; border: 1px solid #DCE5EC; border-top: none; background: #FFFFFF;">
        ...
        <p>
          ${isEsign
            ...
            : "Thank you for the opportunity to be part of your project. We're excited about your vision and have put together a proposal tailored to the scope of work we've discussed."}
        </p>
        <div style="margin-bottom: 12px;">
          <div style="font-size: 0.65rem; letter-spacing: 0.1em; text-transform: uppercase; color: ${GOLD}; font-weight: 600; margin-bottom: 2px;">Proposal Total</div>
        ...
        <p style="margin-top: 18px;">
          ${isEsign
            ...
            : "Please take some time to review the proposal at your convenience. When you're ready to move forward, simply click Approve to accept and sign. If you have any questions or would like to discuss any part of the proposal, please don't hesitate to reach out."}
        </p>
        ...
        ${isEsign ? '' : `
        <p style="margin-top: 18px;">
          We look forward to working with you and bringing your project to life.
        </p>
        `}
        <p style="margin-top: 18px;">
          Sincerely,<br/>
