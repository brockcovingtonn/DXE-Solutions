  ...
  const html = `
    <div style="font-family: -apple-system, Helvetica, Arial, sans-serif; max-width: 480px; margin: 0 auto; color: ${NAVY};">
      <div style="background: ${NAVY_DARK}; padding: 22px 24px; text-align: center;">
        ...
        <span style="color: rgba(255,255,255,0.4); font-size: 15px; margin: 0 10px; vertical-align: middle; display: inline-block;">&times;</span>
        <img src="${SITE_URL}/images/higher-thinking-logo.png" alt="Higher Thinking Consulting" height="38" style="height: 38px; width: auto; vertical-align: middle; display: inline-block;" />
      </div>
