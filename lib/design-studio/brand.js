...
export const BRAND = {
  ...
  // Quote numbers render as DS-2026-0001
  quotePrefix: 'DS',
};

// Contact line shown on the Design Studio client proposal specifically —
// deliberately separate from BRAND.email/BRAND.phone above, which are the
// general DXE Solutions contact used elsewhere (e.g. other proposal PDFs).
export const DESIGN_STUDIO_CONTACT = {
  email: 'higherthinkingconsulting@gmail.com',
  phone: '818.523.7012',
};
...
export const S = {
  ...
  btnSm: { padding: '6px 12px', background: C.ink, color: C.paper, border: 'none', borderRadius: 6, fontSize: 12.5, fontWeight: 600, cursor: 'pointer' },
  btnGhostSm: { padding: '6px 12px', background: 'transparent', color: C.ink, border: `1px solid ${C.line}`, borderRadius: 6, fontSize: 12.5, fontWeight: 600, cursor: 'pointer' },
