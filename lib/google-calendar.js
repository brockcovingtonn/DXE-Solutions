...
// Employees don't get their own Google Calendar connection — their
// events sync to whichever admin has one connected (in practice, the
// business's single Google Calendar). Returns that admin's user_id, or
// null if no admin has connected yet.
