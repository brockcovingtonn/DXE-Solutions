// Helper for client-portal pages and native API routes: returns the
// project if the current user owns it, is an admin (admins can preview
// any project via "View as client" links from the admin dashboard), or
// is an employee assigned to it (native document/photo uploads).
