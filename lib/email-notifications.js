...
export async function notifyAdminOfEstimateRequest({
  ...
  const html = wrapEmail({
    ...
    bodyHtml: `
      ...
      ${field('Estimated Value', escapeHtml(projectValue || 'Not specified'))}
      ${field('Location', escapeHtml(location || 'Not specified'))}
      ${field('Service Needed', escapeHtml(serviceNeeded || 'Not specified'))}
