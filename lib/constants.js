...
// Training categories: "General" applies to every project regardless of
// type, shown alongside whichever specific PROJECT_TYPES category an
// employee is browsing.
export const TRAINING_CATEGORIES = ['General', ...PROJECT_TYPES];
