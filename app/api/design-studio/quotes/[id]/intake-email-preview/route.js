...
import { buildIntakeEmail } from '@/lib/design-studio/email';

export const dynamic = 'force-dynamic';

// Read-only: composes exactly what send-intake-email would send, without
// sending it, so staff can approve the actual content first.
export async function GET(request, { params }) {
  try {
    ...
    const email = buildIntakeEmail(quote);
