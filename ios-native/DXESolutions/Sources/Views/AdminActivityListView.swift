...
struct AdminActivityListView: View {
    ...
    var body: some View {
        Group {
            if isLoading {
                ...
                EmptyStateView(icon: "clock", title: "No activity yet", subtitle: "Activity across all projects will show up here.")
    ...
    private func rowContent(_ item: ActivityItem) -> some View {
