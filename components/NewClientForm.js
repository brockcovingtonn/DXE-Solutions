...
export default function NewClientForm() {
  ...
  return (
    <form className={adminStyles.adminForm} onSubmit={handleSubmit}>
      ...
      <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.1rem', margin: '1.5rem 0 1rem', color: 'var(--navy)', paddingTop: '1.5rem', borderTop: '1px solid rgba(var(--border-rgb),0.08)' }}>
        First project
      </h3>
